...
**Варианты:**
- ✓ не требует ручного создания и хранения ключа
...
**Варианты:**
- ✓ анализирует задачу без изменения файлов проекта
...
- ✓ TUI предоставляет интерактивные панели поверх терминала
...
- ✓ он ориентирован на Unix-среду и стабильнее там
...
**Варианты:**
- ✓ агрегатор, дающий доступ к моделям через один ключ
...
**Варианты:**
- ✓ добавлять конкретные команды запуска и тестов
- ○ хранить все правила в одном файле для простоты навигации
- ✓ держать файл компактным, не более 200 строк
...
- ✓ задача выполняется в облаке без участия разработчика
...
- ✓ коллеги будут работать без общих инструкций для агента
...
- ✓ анализирует проект и создаёт файл с контекстом
