...
**Варианты:**
- ✓ Он часто повторяется
- ✓ Маршрут достаточно стабилен
...
- ✓ Skill скрывает спорное решение внутри автоматизации
...
**Варианты:**
- ✓ Готовить debugging brief
- ○ Сам решать спорную миграцию
- ✓ Проверять AI-diff по критериям
- ✓ Собирать handoff-заметку
