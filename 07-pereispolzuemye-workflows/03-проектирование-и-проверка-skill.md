...
**Варианты:**
- ✓ Корень репозитория: .agents/skills/
- ✓ Рабочая директория: .agents/skills/
- ✓ Системный: /etc/codex/skills/
- ○ Браузерный: browser://codex/skills/
- ✓ Пользовательский: ~/.agents/skills/
...
**Варианты:**
- ✓ Описывает UI-метаданные, политику вызова и зависимости skill
...
- ✓ Команда выполняется до отправки агенту, её вывод подставляется в текст
...
- ✓ Через синтаксис @filename в тексте правила
...
- ✓ Только когда без него агент стабильно возвращает результат хуже
