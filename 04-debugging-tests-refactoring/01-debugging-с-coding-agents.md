...
- ✓ Сделать проблему наблюдаемой и воспроизводимой
...
- ✓ Потому что он слишком широк для расследования
...
- ✓ Карта связанного участка и точек проверки
...
- ✓ Он сразу показывает diff и правки
...
- ✓ Уже доступные сигналы и ограничения
- ✓ Шаги воспроизведения
...
- ✓ Просьба назвать точки сбоя и порядок проверки
- ✓ Просьба перечислить только связанные файлы
- ✓ Явный запрет редактировать код
