...
- ✓ Чтобы вынести повторяющиеся правила из чата
...
**Варианты:**
- ✓ Повторяющиеся правила и соглашения
...
**Варианты:**
- ✓ Оставить в нём карту, детали вынести
...
- ✓ После правок запусти тесты и дай результат
...
- ✓ Чтобы читать правила только по текущей зоне
...
**Варианты:**
- ✓ Где лежат тесты, docs и основные модули
- ✓ Что нельзя менять без явного запроса
- ○ Историю всех прошлых обсуждений в чате
- ✓ Какие команды использовать для проверок
...
**Варианты:**
- ✓ Он помогает сделать формулировки проверяемыми
- ✓ Он экономит время на первом черновике правил
- ✓ Он может быстро превратить пожелания в структуру
...
- ✓ Короткая карта проекта с чёткими ограничениями
