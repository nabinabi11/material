...
**Варианты:**
- ✓ Задокументированный контракт: tools и их параметры
...
- ✓ Агрегирует серверы из более чем 12 источников
...
- ✓ Smithery предоставляет hosted-режим со встроенным OAuth
...
- ✓ Звёзды не говорят об активности и контракте сервера
...
**Варианты:**
- ✓ Проектный коммитится в репозиторий
...
- ✓ Подтягивает актуальную документацию библиотек в контекст
...
- ✓ Сервер работает в контейнере без установки зависимостей
...
- ✓ Агент не сможет выйти за пределы этих путей
...
- ✓ Агент может создавать PR и issues — это побочные эффекты
