...
**Варианты:**
- ✓ Потому что патч показывает реальные изменения
...
- ✓ С карты файлов и границ задачи
...
**Варианты:**
- ✓ Локальная задача затронула много слоёв
...
- ✓ Вернуть задачу агенту на сужение
...
- ✓ Затем отделить обязательное от попутного
- ✓ После этого идти в чувствительные места
- ✓ Сначала посмотреть набор изменённых файлов
...
- ✓ В нём нет лишней полировки без нужды
- ✓ Он связан с одной понятной целью
...
**Варианты:**
- ✓ Формат финального отчёта по файлам
- ✓ Условие остановки при слишком широком плане
- ✓ Ограничения по области изменений
