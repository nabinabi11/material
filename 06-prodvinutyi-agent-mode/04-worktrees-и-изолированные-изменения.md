...
- ✓ Для рискованного отдельного прохода
...
**Варианты:**
- ✓ Codex Handoff переносит тред между Local и Worktree
- ○ Codex CLI уже имеет флаг --worktree
- ✓ Cursor /apply-worktree помогает вернуть результат
- ✓ Claude Code хранит worktrees в .claude/worktrees/
...
**Варианты:**
- ✓ Чтобы восстановить нужную среду
...
- ✓ Review видит меньше постороннего шума
...
**Варианты:**
- ✓ Каждый вариант имеет своё физическое состояние
- ✓ Diff каждого подхода можно читать отдельно
- ○ Сравнение заменяется выбором самой новой модели
- ✓ Соседние эксперименты меньше смешиваются
