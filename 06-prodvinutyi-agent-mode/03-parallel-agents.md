...
**Варианты:**
- ✓ Интеграция заранее выглядит ясной
...
**Варианты:**
- ✓ Слишком широкая область правок
- ✓ Неподготовленный контекст
...
**Варианты:**
- ○ В Codex subagents нужно запускать явно
...
- ✓ По типу зависимости между ветками
...
**Варианты:**
- ✓ Что именно ветка должна вернуть
- ✓ Какие соседние участки нельзя трогать
- ✓ Какие файлы и слои в неё входят
...
**Варианты:**
- ✓ Сначала сверить артефакт, потом смысловые конфликты
...
- ✓ Два параллельных read-only исследования
